...
def main():
    ...
    for tabla in GRUPO_F:
        ...
        reporte.append(f"{tabla} | {regex_count} | {parser_count} | {total} | {unique} | {dups} | {status}")

    print("\n\n--- REPORTE FINAL ---")
    print("tabla | local_count | parser_count | remote_total | unique_source | duplicate_sources | ingest_health")
    for r in reporte:
        print(r)
