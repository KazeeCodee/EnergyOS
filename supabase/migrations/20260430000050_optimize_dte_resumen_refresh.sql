-- Optimiza T2.5: reemplaza acumuladores array_agg por contadores de seccion/unidad.
-- Mantiene el mismo contrato y schema de dte_resumen_agente.
...
as $$
declare
  v_parser_version text := 'dte_resumen_agente_v2';
  v_inserted int := 0;
  v_deleted int := 0;
begin
