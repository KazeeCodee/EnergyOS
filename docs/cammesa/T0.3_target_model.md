...
>
> **Insumos.** [T0.1](T0.1_dictionary.md) (diccionario `raw_*`) + [T0.2](T0.2_supabase_gap.md) (gap Supabase) + roadmap de Fases del proyecto.
...
Mismas 23 columnas del [T0.1 §3 raw_anexo_gume layout 2026+](T0.1_dictionary.md#layout-2026-anexo_gumehtml-23-cols).
